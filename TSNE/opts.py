...
parser.add_argument('--num_epochs', type=int, default=50, help='Number of epochs to train on') #50
...
parser.add_argument('--loss_type', default="DML2", type=str, help='loss type')
...
parser.add_argument('-b','--batch_size', default=32, type=int, help='define batch size') #128
...
parser.add_argument('--num_runs', default=1, type=int, help='number of runs to launch ')
